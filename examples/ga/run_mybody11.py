...
def run_mybody(experiment_name, structure_shape, max_evaluations, train_iters, num_cores):   #此文件与GA文件夹中run文件功能一致#
    ...
    robot_label = [7, 10, 5, 6, 3, 18, 13, 2, 14, 8, 17, 16]
    print(robot_label)
    ...
    #actor_critic.load_state_dict(torch.load(os.path.join(root_dir,"saved_data","203.2","controller","robot_"+str(21)+"_controller"+".pt"))[0].state_dict())
    ...
    while True:
        ...
        for structure in structures:           
            ...
            group.add_job(run_mybodyppo11, ppo_args, callback=structure.set_reward)   #对随机生成的机器人添加训练的进程，可以用于获得奖励#
