...
def run_meta(experiment_name, structure_shape, max_evaluations, train_iters, num_cores):   #此文件与GA文件夹中run文件功能一致#
    print()
    ...
    #robot_label = np.random.choice(np.setdiff1d(np.arange(28), [7, 10, 5, 6, 3, 18, 13, 2, 14, 8, 17, 16]),max_evaluations,replace=False)
    # robot_label =[14,13,34,19,29,1,18,35,23,9]
    # print(robot_label)
    ...
    # actor_critic.load_state_dict(torch.load(os.path.join(root_dir,"saved_data","107.2","controller","robot_"+str(31)+"_controller"+".pt"))[0].state_dict())
