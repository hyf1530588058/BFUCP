...
from ppo.evaluate_orign import evaluate
...
def run_nslcppo(          #此文件功能与ppo原文件夹中的run文件功能一致#
    ...
    print(f'Starting training for offspring {saving_convention[1]}')
    ...
    for j in range(num_updates):
        ...
        for step in range(args.num_steps):
            ...
            with torch.no_grad():
                #print("rollouts.obs[step]:",rollouts.obs[step].shape)
                value, action, action_log_prob, recurrent_hidden_states = actor_critic.act(     #动作#
        ...
        #     file_path = os.path.join(origin_dir,"3100-4.2",str(saving_convention[1]))  
