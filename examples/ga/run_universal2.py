...
def run_universal2(experiment_name, structure_shape, max_evaluations, train_iters, num_cores):   #此文件与GA文件夹中run文件功能一致#
    print()
    ...
    # robot_label = [13,19,54,21,6,9,29,22,11]
    # print(robot_label)
    #generate a population
    # directory = os.path.join(root_dir,"robot_universal/Test_walker_10")
    ...
    # actor_critic.load_state_dict(torch.load(os.path.join(root_dir,"saved_data","robust_HM_walker_01","robot_robust7_0_1_controller"+".pt"),map_location=device)[0].state_dict())
    # actor_critic.load_state_dict(torch.load(os.path.join(root_dir,"saved_data","Adversary_HM_walker_01","robot_7_controller"+".pt"),map_location=device)[0].state_dict())
    while True:
