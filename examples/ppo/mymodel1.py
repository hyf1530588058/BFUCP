...
class TransformerModel(nn.Module):
    def __init__(self, obs_shape = None, decoder_out_dim=1): 
        ...
        # self.pos_embedding = PositionalEncoding(8, seq_len)  #(feature_dim,num_nodes)#
    ...
    def forward(self, structure, obs_env, local_obs, obs_cm_mask=None, return_attention=False):  
        ...
        obs_rep, attention_maps = self.gnn.forward(node_feature.to(device), WW,mask_matrix,R_change,node_type,change_body,rechange)  #输入HGT模型，返回张量形状为(feature_dim,batch_size,25)#
